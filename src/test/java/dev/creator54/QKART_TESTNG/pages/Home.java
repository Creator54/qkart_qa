...
public class Home {
    ...
    public Boolean PerformLogout() throws InterruptedException {
        try {
            ...
            WebElement logout_button = wait.until(ExpectedConditions.visibilityOfElementLocated (By.className("MuiButton-text")));
            logout_button.click();
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.cssSelector (".MuiTypography-root.MuiTypography-body1.css-yg30e6")));
...
//            System.out.println("Error while searching for a product: " + e.getMessage());
    ...
    public List<WebElement> getSearchResults() {
        ...
        try {
            searchResults = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy (By.className ("css-1qw96cp")));
        } catch (Exception e) {
//            System.out.println("There were no search results: " + e.getMessage());
    ...
    public Boolean addProductToCart(String productName) {
        try {
             ...
             */
            List<WebElement> gridContent = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.className ("css-sycj1h")));
    ...
    public Boolean clickCheckout() {
        Boolean status = false;
        try {
            WebElement checkoutBtn = wait.until(ExpectedConditions.visibilityOfElementLocated (By.className("checkout-btn")));
            checkoutBtn.click();
